export const metadata = {
	title: 'АСТРАНИТ | СОГЛАШЕНИЕ ОБ ОБРАБОТКЕ ПЕРСОНАЛЬНЫХ ДАННЫХ',
	description: 'АСТРАНИТ СОГЛАШЕНИЕ ОБ ОБРАБОТКЕ ПЕРСОНАЛЬНЫХ ДАННЫХ',
}
		...
		>
			<h3
				style={{
					...
					fontWeight: '500',
					paddingTop: 'clamp(1.5rem, 2.5rem, 3rem)',
			...
			<p
				style={{
					textAlign: 'justify',
					fontSize: 'clamp(1rem, 1.125rem, 1.3125rem)',
					fontWeight: '500',
					lineHeight: '1.6',
				}}
			>
				...
				данных и меры по обеспечению безопасности персональных данных ООО "Рога
				и копыта" (далее – Оператор).
			</p>
			...
			<p
				style={{
					...
					fontWeight: '500',
					lineHeight: '1.6',
					marginTop: 'clamp(1rem, 1.25rem, 1.5rem)',
				}}
			>
			...
			>
				...
				<br />
				<u>
					<a href='https://example.ru' style={{ color: '#3289a1' }}>
						https://example.ru
					</a>
				</u>
			</p>
			...
			<h3
				style={{
					...
					fontWeight: '500',
					paddingTop: 'clamp(1.5rem, 2rem, 2.5rem)',
					paddingBottom: 'clamp(1.5rem, 2rem, 2.5rem)',
					marginTop: 'clamp(1.5rem, 2rem, 2.5rem)',
				}}
			>
			...
			>
				...
				почты
				<u>
					<a href='mailto:mail@example.ru' style={{ color: '#3289a1' }}>
						{' '}
						mail@example.ru
					</a>
				</u>{' '}
			...
			<p
				style={{
					...
					lineHeight: '1.6',
					marginTop: 'clamp(1rem, 1.25rem, 1.5rem)',
					marginBottom: 'clamp(2rem, 2.5rem, 3rem)',
				}}
			>
				3. Актуальная версия Политики в свободном доступе расположена в сети
				Интернет по адресу
				<u>
					<a href='https://example.ru/personal' style={{ color: '#3289a1' }}>
						{' '}
						https://example.ru/personal
					</a>
				</u>
				.
			</p>
